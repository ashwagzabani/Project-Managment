        ...
        <div className='container'>
          <div className='form-div'>
            <form onSubmit={this.onSubmit}>
              ...
              <input type='text' placeholder='Email ' onChange={(e) => { this.changeEmail(e) }} value={this.state.email} className='form-control-from-group' />
              <input type='password' placeholder='Password ' onChange={(e) => { this.changepassword(e) }} value={this.state.password} className='form-control-from-group' />
              <input type='submit' className='btn btn-danger btn-black' value='Sign Up' />
            </form>
          </div>
        </div>
      </div>
